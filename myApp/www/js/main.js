...
angular.module('app.common')
	...
	function AjaxURL($location){
		...
		this.baseUrl =  'https://shoppins-imanjithreddy.c9users.io/';
...
(function(angular) {
	'use strict';
	angular.module('app.store')
		.controller('StoreLocationCollectionController', ["$scope", "$stateParams", "getCityAreasService", "getCityCategoriesService", 'paramFactory', '$mdDialog', StoreLocationCollectionController]);

	function StoreLocationCollectionController($scope, $stateParams, getCityAreasService, getCityCategoriesService, paramFactory, $mdDialog) {
